...
export class OperatorComponent {
  ...
  public async enrollDevice(): Promise<void> {
    ...
    try {
      const validation = await firstValueFrom(
        this.backend.validateThingDescription(this.deviceEndpoint)
      );
      ...
      this.enrollState = 'error';
      this.enrollError = error?.reason || error?.message || "Transaction failed."; 
    }
  }
